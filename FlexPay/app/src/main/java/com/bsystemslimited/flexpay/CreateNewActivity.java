...
public class CreateNewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button bCreateNewAcc =(Button) findViewById(R.id.bCreateNewAcc);

        bCreateNewAcc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Toast newAcc = Toast.makeText(CreateNewActivity.this, "New Account Created", Toast.LENGTH_LONG);
                newAcc.show();
                Intent myIntent = new Intent(CreateNewActivity.this, DashActivity.class);
